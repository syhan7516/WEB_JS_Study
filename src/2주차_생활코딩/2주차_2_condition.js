...
// ---------------------------------------------------------
// 프로덕트 실습 1 : 프로덕트 html에서 버튼 하나와 조건문을 통해 버튼 클릭 시 배경 색깔이 변하는 기능을 만들어보기!! (색깔자유!)
// 프로덕트 실습 2 : 프로덕트 html에서위의 실습 결과와 같은 방법으로 버튼 3개 더 만들어보기!
// ※ 프로덕트 html 생성 후 html 내에서 script작성!!